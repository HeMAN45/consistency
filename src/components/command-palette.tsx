...
export function CommandPalette({ timezone }: { timezone: string }) {
  ...
  const commands: Command[] = useMemo(
    () => [
      ...
      { id: "watch", label: "Open watch", hint: "W", run: () => go("/watch") },
      { id: "problems", label: "Open problems", hint: "P", run: () => go("/problems") },
      ...
      { id: "analyze", label: "Analyze a playlist", run: () => go("/analyze") },
      { id: "archive", label: "Open the archive", run: () => go("/archive") },
      { id: "sync", label: "Open SYNC", hint: "S", run: () => go("/sync") },
      { id: "chat", label: "Open chat", run: () => go("/chat") },
